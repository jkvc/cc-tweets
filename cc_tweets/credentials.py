...
AUTHS.append(
    Auth(
        consumer_key="XFcNq3rPgkjRFRhqxySasQpDh",
        consumer_secret="KIEB28xLIYABDJFW8ezrzDiKIjjudcPHygfcsZ1Eq9e99rDMbU",
        access_token="2705233580-faDYlgJxOgd3P2LYP0ofh44ZD6pPpZMYFHGd4kP",
        access_token_secret="zvSLSk5ncVCozUhtizaYH4Qv9uRBlzozw5KYeS8PpR57g",
    )
)
AUTHS.append(
    Auth(
        consumer_key="vCcnNJpLxdRBW59yzZOpNAvuR",
        consumer_secret="gS7ZkJ7DLL8sWh13k9R72I6lLprVKUqYGpILiNQaMqtZsQ0prA",
        access_token="2705233580-5MAF6obUOrFatnGFOzYaxPJXJQ6ggtaeUrXqR2j",
        access_token_secret="vTqb9FCkd8YLTyYQVHkYI1ZHmKWteD6r46piMLLNN3Sbn",
    )
)
AUTHS.append(
    Auth(
        consumer_key="hkLVsyHl2KhC1zitr1iIb0Swr",
        consumer_secret="jv8Pjpf2viWYttyfECYSlCI3uvZJajFOY4U1Vcxzm8oQ1In8fB",
        access_token="2705233580-KNHGQiA3fxVkwKwmf2YTn3iSJVoFW8jsdHLOzMp",
        access_token_secret="O4NEP6EP0x76fRu3osZmQOZz5JZkunA6xvw2AYKFgV2gO",
    )
)
